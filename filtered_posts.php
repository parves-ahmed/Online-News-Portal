					...
					<div class="technology">
						<div class="tech-main">
								<div class="tech">
									...
									<a class="power" href="single.html">You can still get into trouble for online posts: Digital law experts</a>
								</div>
								<div class="tech tech-middle">
									<a href="single.html"><img src="images/tech2.jpg" alt="" /></a>
									<a class="power" href="single.html">Indian online buyers among world's unhappiest: UN</a>
								</div>
								<div class="tech">
									<a href="single.html"><img src="images/tech3.jpg" alt="" /></a>
									<a class="power" href="single.html">10 mistakes that will kill your startup</a>
								</div>
								<div class="clearfix"></div>
						</div>
						<div class="tech-main">
								<div class="tech">
									...
									<a class="power" href="single.html">The section of the mass media industry that focuses on presenting</a>
								</div>
								<div class="tech tech-middle">
									<a href="single.html"><img src="images/tech5.jpg" alt="" /></a>
									<a class="power" href="single.html">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</a>
								</div>
								<div class="tech">
									<a href="single.html"><img src="images/tech6.jpg" alt="" /></a>
									<a class="power" href="single.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a>
								</div>
								<div class="clearfix"></div>
						</div>
					</div>
					<header>
						<h3 class="title-head">Tech-News</h3>
					</header>
					<?php foreach ($posts as $post): ?>      
		                <div class="article">
			                <div class="article-left">
				                <a href="single.php?post-slug=<?php echo $post['slug']; ?>"><img src="<?php echo 'http://localhost/web/'.'/images/'.$post['image']; ?>"></a>
			                </div>
			                <div class="article-right">
				                ...
				                <div class="article-text">
				                    <p>The standard chunk of Lorem Ipsum used since the 1500s. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" exact .....</p>
